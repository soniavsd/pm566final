...
In studies conducted outside of the United States, people who were able to commute via physical activity (such as walking and bike riding) were significantly associated with having increased positive health indicators (Chillón, et al., 2012; Andersen et al., 2011). Additionally, those who have access and regularly use public transportation have decreased commute stress compared to those who drive daily([link](https://books.google.com/books?hl=en&lr=&id=4AwOp6sJl3oC&oi=fnd&pg=PP1&dq=United+States+of+American+and+transportation+%22car%22&ots=bQb5vPsFn3&sig=O-1A2h3ZtZgaQ2Lljyx2Ibqg5Xo#v=onepage&q=United%20States%20of%20American%20and%20transportation%20%22car%22&f=false)).

Although it is known in public health and urban planning literature, the majority of the United States is a car centered landscape. Starting in the 1920's, the American population became increasingly interested in personal motor vehicles, forcing administrators and engineers to rapidly build road infrastructure without regard to future potential problems ([link](https://books.google.com/books?hl=en&lr=&id=4AwOp6sJl3oC&oi=fnd&pg=PP1&dq=United+States+of+American+and+transportation+%22car%22&ots=bQb5vPsFn3&sig=O-1A2h3ZtZgaQ2Lljyx2Ibqg5Xo#v=onepage&q=United%20States%20of%20American%20and%20transportation%20%22car%22&f=false)). In 2019, the US Census Bureau reported that 75% of Americans drive alone as their means of transportation, 5% use public transportation, and less than 3% use physical exercise ([link](https://www.census.gov/content/dam/Census/library/publications/2021/acs/acs-48.pdf)).
...
```{r, echo=FALSE}
summary(countyhealth$diabetesrate)
```
...
summary(transhealth$bikepercent)
```
...
```{r, echo=FALSE}
table(transhealth$rankcat)
```

# Summary Statistics

For each death of disease type, higher levels of public transportation use had greater means. Therefore, lower levels of public transportation used as a transportation mode for traveling to work had the best health outcomes.

For each death of disease type, higher levels of car use had greater means. For each disease, there was a trend of greater levels of car use that seemed to be associated with greater mean deaths of Alzheimer, diabetes, and coronary heart disease. Therefore, lower levels of carpool use as a transportation mode for traveling to work had the best health outcomes.

For each death of disease type, higher levels of carpool use had greater means. Therefore, lower levels of carpool use as a transportation mode for traveling to work had the best health outcomes.

We cannot make assumptions about deaths of disease types by levels of walking or bike use due to the fact that there are only low levels of these transportation types. 
...
In the group of scatterplots of percentage of different modes of transportation by death due to Alzheimer's disease, car use and carpool use seems to have a positive association with rate of death from Alzheimer's disease, whereas physical exercise and public transportation had negative associations. None of these graphs had very strong associations. 
...
In the graph of deaths by categories of car use, all disease types had similar trends, in which higher levels of car use had greater rates of deaths, followed by mid-high levels, then low-mid levels. In the graph of deaths by categories of carpool use, low levels had higher rates of each type of disease, followed by low-mid carpool use. Low levels of public transportation were associated with higher levels of deaths from the three disease types. Lastly, biking and walking only had one category (low levels), so we are unable to compare these modes of transportations with deaths due to Alzheimer's, Diabetes, and Coronary heart disease. 
